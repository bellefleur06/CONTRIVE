				...
				<div class="row justify-content-between align-items-center">
					...
					<div class="app-utility-item app-notifications-dropdown dropdown">    
						<a class="dropdown-toggle no-toggle-arrow" id="notifications-dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-expanded="false">
							...
							<?php
									$sql = "SELECT * FROM orders WHERE notification_status = '0' AND status != 'Received' AND status != 'Returning' AND status != 'Returned'";
									$result = mysqli_query($conn, $sql);
									$count = mysqli_num_rows($result);
								?>
								<?php if ($count > 0) : ?>
					        		<span class="icon-badge"><?php echo $count; ?></span>
								<?php else : ?>
					        ...
					        <div class="dropdown-menu p-0" aria-labelledby="notifications-dropdown-toggle">
								...
								<?php
									$sql = "SELECT * FROM orders WHERE notification_status = '0' AND status != 'Received' AND status != 'Returning' AND status != 'Returned' ORDER BY id DESC";
									$result = mysqli_query($conn, $sql);
									$count = mysqli_num_rows($result);
							       ...
							       <div class="item p-3">
								        <div class="row gx-2 justify-content-between align-items-center">
									        ...
									        <div class="col">
										        <div class="info"> 
											        <div class="desc"> <?php echo "Your Order " . $order_id  . " is " .  $status ; ?></div>
