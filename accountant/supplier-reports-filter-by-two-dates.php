    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <a href="supplier-reports-filter-by-two-dates.php" class="btn app-btn btn-info" style="margin-bottom: 0.5em; color:white"><i class="fa fa-calendar"></i> Between Two Dates</a>
                <hr class="mb-4">
                                ...
                                <div class="app-card-body">
                                    <div class="mb-3">
                                        <table id="myTable" class="table app-table-hover mb-0 text-left">
                                            <thead>
                                                <?php
                                                $sql = "SELECT * FROM suppliers WHERE date_added BETWEEN '$from_date' AND '$to_date' GROUP BY name ORDER BY date_added";
