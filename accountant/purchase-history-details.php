                        ...
                        <div class="app-card app-card-settings shadow-sm p-4">
                            <div class="app-card-body">
                                <table class="table text-left">
                                    <thead>
                                        <a href="purchase-order-history.php" class="btn app-btn btn-info" style="color:white; float:right"><i class="fa fa-arrow-left"></i> Go Back</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                                ...
                                                <td style="padding-top:1.5em">
                                                    <p style="font-weight:bold; color:green; text-align:right">Received</p>
                                                </td>
                                        <tr>
                                            <td style="padding-top:1.5em">
                                            ...
                                            <td style="padding-top:1.5em">
                                                <p style="font-weight:bold; text-align:right"><?php echo $date = date("M d, Y - h:i a", strtotime($date_received)); ?></p>
                                            </td>
                                        </tr>
                                    <?php
                                    ...
                                    ?>
                                        ...
                                        <td style="padding-top:1.5em">
                                            <p style="font-weight:bold; color:green; text-align:right">Returned</p>
                                        </td>
                                        <tr>
                                            <td style="padding-top:1.5em">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-top:1.5em">
                                                <p style="font-weight:bold; text-align:right"><?php echo $date = date("M d, Y - h:i a", strtotime($date_returned)); ?></p>
                                            </td>
                                        </tr>
                                    <?php
                                            }
