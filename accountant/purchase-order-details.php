                        ...
                        <div class="app-card app-card-settings shadow-sm p-4">
                            <div class="app-card-body">
                                <table class="table text-left">
                                    <thead>
                                        <a href="manage-purchase-orders.php" class="btn app-btn btn-info" style="color:white; float:right"><i class="fa fa-arrow-left"></i> Go Back</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                                ...
                                                <td style="padding-top:1.5em">
                                                    <p style="font-weight:bold; color:blue; text-align:right">Order Pending</p>
                                                </td>
                                            <?php
                                            ...
                                            ?>
                                                ...
                                                <td style="padding-top:1.5em">
                                                    <p style="font-weight:bold; color:gold; text-align:right">Order Approved</p>
                                                </td>
                                        <tr>
                                            <td style="padding-top:1.5em">
                                                <p style="font-weight:bold">Date Approved:</p>
                                            </td>
                                            <td style="padding-top:1.5em">
                                                <p style="font-weight:bold; text-align:right"><?php echo $date = date("M d, Y - h:i a", strtotime($date_approved)); ?></p>
                                            </td>
                                        </tr>
                                    <?php
                                    ...
                                    ?>
                                        ...
                                        <td style="padding-top:1.5em">
                                            <p style="font-weight:bold; color:red; text-align:right">Order Rejected</p>
                                        </td>
                                        <tr>
                                            <td style="padding-top:1.5em">
                                                <p style="font-weight:bold">Rejection Reason:</p>
                                            </td>
                                            <td style="padding-top:1.5em">
                                                <p style="font-weight:bold; text-align:right"><?php echo $rejection_reason; ?></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding-top:1.5em">
                                                <p style="font-weight:bold">Date Rejected:</p>
                                            </td>
                                            <td style="padding-top:1.5em">
                                                <p style="font-weight:bold; text-align:right"><?php echo $date = date("M d, Y - h:i a", strtotime($date_rejected)); ?></p>
                                            </td>
                                        </tr>
                                    <?php
                                            }
