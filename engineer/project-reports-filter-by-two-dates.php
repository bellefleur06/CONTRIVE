    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <a href="project-reports-filter-by-two-dates.php" class="btn app-btn btn-info" style="margin-bottom: 0.5em; color:white"><i class="fa fa-calendar"></i> Between Two Dates</a>
                <hr class="mb-4">
                ...
                <form class="settings-form" method="post">
                    <div class="row">
                        ...
                        <div class=" mb-3">
                            ...
                            <a href="project-reports-filter-by-two-dates.php" class="btn app-btn btn-danger" style="color:#fff">Clear</a>
                        </div>
                    </div>
                </form>
                                    ...
                                    <form class="settings-form">
                                        <div class="mb-3">
                                            <table id="myTable" class="table app-table-hover mb-0 text-left">
                                                <thead>
                                                    <?php
                                                    $sql = "SELECT * FROM projects WHERE date_added BETWEEN '$from_date' AND '$to_date' ORDER BY date_added";
