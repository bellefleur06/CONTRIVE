	...
	<div class="app-wrapper">
		...
		<div $page='client' ; class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				...
				<a href="project-reports.php" class="btn app-btn btn-info" style="margin-bottom: 0.5em; color:white"><i class="fa fa-calendar"></i> Month and Year</a>
				<a href="project-reports-filter-by-month-only.php" class="btn app-btn" style="margin-bottom: 0.5em; border:1px solid #000"><i class="fa fa-calendar"></i> Month Only</a>
				...
				<form class="settings-form" method="post">
					<div class="row">
						...
						<div class="mb-3">
							...
							<a href="project-reports.php" class="btn app-btn btn-danger" style="color:#fff">Clear</a>
						</div>
					</div>
				</form>
