...
<body>
    ...
    <div class="container">
        <center>
            <h1 class="my-3">Projects Master List</h1>
        </center>
        ...
        <button class="btn btn-info noprint" style="color:white; float:right" onclick="print()"><i class="fa fa-print"></i> Click here to Print</button>
    </div>
</body>
