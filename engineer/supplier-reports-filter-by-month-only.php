        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <nav id="reports-table-tab" class="reports-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
                    ...
                    <a class="flex-sm-fill text-sm-center nav-link" data-bs-toggle="tab" href="billing-report.php" role="tab" aria-selected="false">Materials</a>
                </nav>
                <!-- TABS -->
                ...
                <a href="supplier-reports.php" class="btn app-btn" style="margin-bottom: 0.5em; border:1px solid #000"><i class="fa fa-calendar"></i> Month and Year</a>
                <a href="supplier-reports-filter-by-month-only.php" class="btn app-btn btn-info" style="margin-bottom: 0.5em; color:white"><i class="fa fa-calendar"></i> Month Only</a>
                ...
                <form class="settings-form" method="post">
                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <a href="supplier-reports-filter-by-month-only.php" class="btn app-btn btn-danger" style="color:#fff">Clear</a>
                        </div>
                    </div>
                </form>
