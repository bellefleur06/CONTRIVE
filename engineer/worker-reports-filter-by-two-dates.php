    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <a href="worker-reports-filter-by-month-only.php" class="btn app-btn" style="margin-bottom: 0.5em; border:1px solid #000"><i class="fa fa-calendar"></i> Month Only</a>
                ...
                <a href="worker-reports-filter-by-two-dates.php" class="btn app-btn btn-info" style="margin-bottom: 0.5em; color:white"><i class="fa fa-calendar"></i> Between Two Dates</a>
                <hr class="mb-4">
                ...
                <form class="settings-form" method="post">
                    <div class="row">
                        ...
                        <div class=" mb-3">
                            ...
                            <a href="worker-reports-filter-by-two-dates.php" class="btn app-btn btn-danger" style="color:#fff">Clear</a>
                        </div>
                    </div>
                </form>
                                ...
                                <div class="app-card-body">
                                    <div class="mb-3">
                                        <table id="myTable" class="table app-table-hover mb-0 text-left">
                                            <thead>
                                                <?php
                                                $sql = "SELECT * FROM workers  WHERE date_added BETWEEN '$from_date' AND '$to_date' GROUP BY emp_id ORDER BY date_added";
