...
<head>
    <title>CONTRIVE | Staff Reports</title>
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <nav id="reports-table-tab" class="reports-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
                    ...
                    <a class="flex-sm-fill text-sm-center nav-link active" data-bs-toggle="tab" href="staff-reports.php" role="tab" aria-selected="false">Staffs</a>
                ...
                <h1 class="app-page-title"><span class="nav-icon"><i class="fa fa-list"></i></span> Staff Reports</h1>
                ...
                <a href="staff-reports.php" class="btn app-btn" style="margin-bottom: 0.5em; border:1px solid #000"><i class="fa fa-calendar"></i> Month and Year</a>
                <a href="staff-reports-filter-by-month-only.php" class="btn app-btn btn-info" style="margin-bottom: 0.5em; color:white"><i class="fa fa-calendar"></i> Month Only</a>
                <a href="staff-reports-filter-by-year-only.php" class="btn app-btn" style="margin-bottom: 0.5em; border:1px solid #000"><i class="fa fa-calendar"></i> Year Only</a>
                <a href="staff-reports-filter-by-two-dates.php" class="btn app-btn" style="margin-bottom: 0.5em; border:1px solid #000"><i class="fa fa-calendar"></i> Between Two Dates</a>
                <hr class="mb-4">
                ...
                <form class="settings-form" method="post">
                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <a href="staff-reports-filter-by-month-only.php" class="btn app-btn btn-danger" style="color:#fff">Clear</a>
                        </div>
                    </div>
                </form>
                                ...
                                <div class="app-card-body">
                                    <div class="mb-3">
                                        <table id="myTable" class="table app-table-hover mb-0 text-left">
                                            <thead>
                                                <?php
                                                $sql = "SELECT * FROM staffs WHERE month(date_added) = '$month' AND year(date_added) = '$year' GROUP BY staff_id ORDER BY date_added";
                                            ...
                                            <tbody>
                                                <?php while ($row = mysqli_fetch_array($result)) { ?>
                                                    <tr>
                                                        <td class="cell" style="padding-top: 0.5em"><?php echo $row['full_name']; ?></td>
                                                        <td class="cell" style="padding-top: 0.5em"><?php echo $row['access']; ?></td>
                                                        <td class="cell" style="padding-top: 0.5em"><?php echo $date = date("M d, Y", strtotime($row['date_added'])); ?></td>
                                                        <td><a href="staff-report-details.php?ID=<?php echo $row['id']; ?>" class="btn app-btn btn-success" style="color:white"><i class="fa fa-eye"></i> View</a></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
                                ...
                                <div class="app-card-body">
                                    <div class="mb-3">
                                        <table id="myTable" class="table app-table-hover mb-0 text-left">
                                            <thead>
                                                <?php
                                                $sql = "SELECT * FROM staffs GROUP BY staff_id ORDER BY date_added";
                                                $result = mysqli_query($conn, $sql);
                                                ?>
                                                <tr>
                                                    <th class="cell">Name</th>
