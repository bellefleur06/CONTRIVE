    ...
    <div class="app-wrapper">
        ...
        <div $page='client' ; class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <a href="purchase-reports-filter-by-year-only.php" class="btn app-btn btn-info" style="margin-bottom: 0.5em; color:white"><i class="fa fa-calendar"></i> Year Only </a>
                ...
                <form class="settings-form" method="post">
                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <a href="purchase-reports-filter-by-year-only.php" class="btn app-btn btn-danger" style="color:#fff">Clear</a>
                        </div>
                    </div>
                </form>
                                    ...
                                    <form class="settings-form">
                                        <div class="mb-3">
                                            <table id="myTable" class="table app-table-hover mb-0 text-left">
                                                <thead>
                                                    <?php
                                                    $sql = "SELECT * FROM orders, payables WHERE orders.order_id = payables.order_id AND year(payables.date_ordered) = '$year' ORDER BY payables.date_ordered";
