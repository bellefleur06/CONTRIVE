...
<head>
    <title> CONTRIVE | Purchase History </title>
    ...
    <div class="app-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <h1 class="app-page-title"><span class="nav-icon"><i class="fa fa-list"></i></span> Purchase History</h1>
                ...
                <!-- alert messages -->
                <?php
                if (isset($_SESSION['order-received'])) {
                ?>
                    <div class="alert alert-success alert-dismissible fade show" id="alert" role="alert">
                        <strong> <?php echo $_SESSION['order-received']; ?> </strong>
                        <button type="button" class="btn-close" data-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php
                    unset($_SESSION['order-received']);
                }
                if (isset($_SESSION['order-returned'])) {
                ?>
                    <div class="alert alert-success alert-dismissible fade show" id="alert" role="alert">
                        <strong> <?php echo $_SESSION['order-returned']; ?> </strong>
                        <button type="button" class="btn-close" data-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php
                    unset($_SESSION['order-returned']);
                }
                ?>
                                ...
                                <form class="settings-form">
                                    <div class="mb-3">
                                        <table id="myTable" class="table app-table-hover mb-0 text-left">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql = "SELECT * FROM materials, orders WHERE orders.product_id = materials.id AND status != 'Pending' AND status != 'Rejected' AND status != 'On Delivery' AND status != 'Returning' ORDER BY orders.id DESC";
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            ?>
                                                                <td class="cell" style="padding-top: 1em; font-weight:bold; color:red">Returned</td>
                                                            <?php
                                                            }
                                                            ?>
                                                            <td><a href="purchase-history-details.php?ID=<?php echo $id; ?>" class="btn app-btn btn-success" style="color:white"><i class="fa fa-eye"></i> View</a></td>
                                                        </tr>
                                                <?php
                                                    }
                                                } else {
