...
$mail->SMTPSecure = "tls";
    ...
    $mail->Body = "<p>Order $order_id - $qty$unit of $product_name has been received successfully.</p>"; // dito sa body pwede mo designan ng html at css yung body ng email natin
