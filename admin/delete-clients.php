...
if (!isset($_GET['ID'])) {
  ...
  $_SESSION['client-not-found'] = "Client Not Found.";
  ...
  $activity = "Delete Client Record of " . $clientname;
  ...
  if ($result == TRUE) {
    ...
    $_SESSION['delete-clients'] = "Client Removed Successfully!";
    header("Location: manage-clients.php");
  } else {

    $_SESSION['failed-to-delete'] = "Failed to Remove Client.";
    header("Location: manage-clients.php");
  }
}
