...
<head>
    <title>CONTRIVE | Worker Reports</title>
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <nav id="reports-table-tab" class="reports-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
                    ...
                    <a class="flex-sm-fill text-sm-center nav-link active" data-bs-toggle="tab" href="worker-reports.php" role="tab" aria-selected="false">Workers</a>
                ...
                <h1 class="app-page-title"><span class="nav-icon"><i class="fa fa-list"></i></span> Worker Reports</h1>
                ...
                <a href="worker-reports.php" class="btn app-btn" style="margin-bottom: 0.5em; border:1px solid #000"><i class="fa fa-calendar"></i> Month And Year</a>
                <a href="worker-reports-filter-by-month-only.php" class="btn app-btn btn-info" style="margin-bottom: 0.5em; color:white"><i class="fa fa-calendar"></i> Month Only</a>
                <a href="worker-reports-filter-by-year-only.php" class="btn app-btn" style="margin-bottom: 0.5em; border:1px solid #000"><i class="fa fa-calendar"></i> Year Only</a>
                <a href="worker-reports-filter-by-two-dates.php" class="btn app-btn" style="margin-bottom: 0.5em; border:1px solid #000"><i class="fa fa-calendar"></i> Between Two Dates</a>
                <hr class="mb-4">
                ...
                <form class="settings-form" method="post">
                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <a href="worker-reports-filter-by-month-only.php" class="btn app-btn btn-danger" style="color:#fff">Clear</a>
                        </div>
                    </div>
                </form>
                                ...
                                <div class="app-card-body">
                                    <div class="mb-3">
                                        <table id="myTable" class="table app-table-hover mb-0 text-left">
                                            <thead>
                                                <?php
                                                $sql = "SELECT * FROM workers WHERE month(date_added) = '$month' AND year(date_added) = '$year' GROUP BY emp_id ORDER BY date_added";
                                            ...
                                            <tbody>
                                                <?php while ($row = mysqli_fetch_array($result)) { ?>
                                                    <tr>
                                                        <td class="cell" style="padding-top: 0.5em"><?php echo $row['first_name'] . " " . $row['last_name']; ?></td>
                                                        <td class="cell" style="padding-top: 0.5em"><?php echo $row['position']; ?></td>
                                                        <td class="cell" style="padding-top: 0.5em"><?php echo $date = date("M d, Y", strtotime($row['date_added'])); ?></td>
                                                        <td><a href="worker-report-details.php?ID=<?php echo $row['id']; ?>" class="btn app-btn btn-success" style="color:white"><i class="fa fa-eye"></i> View</a></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
                                ...
                                <div class="app-card-body">
                                    <div class="mb-3">
                                        <table id="myTable" class="table app-table-hover mb-0 text-left">
                                            <thead>
                                                <?php
                                                $sql = "SELECT * FROM workers GROUP BY emp_id ORDER BY date_added";
                                                $result = mysqli_query($conn, $sql);
                                                ?>
                                                <tr>
                                                    <th class="cell">Name</th>
