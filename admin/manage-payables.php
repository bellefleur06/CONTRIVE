...
<head>
	<title> CONTRIVE | Manage Payables</title>
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				<ol class="breadcrumb mb-4" style="float:right">
					...
					<li class="breadcrumb-item">Manage Payables</li>
				</ol>
				<h1 class="app-page-title"><span class="nav-icon"><i class="fa fa-list"></i></span> Manage Payables</h1>
				<!-- <a href="print-clients.php" class="btn app-btn btn-info" style="color:white"><i class=" fa fa-print"></i> Print List</a> -->
				<hr class="mb-4">
				<?php
				if (isset($_SESSION['update-payables'])) {
				?>
					<div class="alert alert-success alert-dismissible fade show" id="alert" role="alert">
						<strong> <?php echo $_SESSION['update-payables']; ?> </strong>
						<button type="button" class="btn-close" data-dismiss="alert" aria-label="Close"></button>
					</div>
				<?php
					unset($_SESSION['update-payables']);
				}
				if (isset($_SESSION['payable-not-found'])) {
				?>
					<div class="alert alert-danger alert-dismissible fade show" role="alert">
						<strong> <?php echo $_SESSION['payable-not-found']; ?> </strong>
						<button type="button" class="btn-close" data-dismiss="alert" aria-label="Close"></button>
					</div>
				<?php
					unset($_SESSION['payable-not-found']);
				}
				?>
									...
									<div class="mb-3">
										<table id="myTable" class="table app-table-hover mb-0 text-left">
											...
											<tbody>
												...
												?>
														<tr>
															<td class="cell" style="padding-top: 1em"><?php echo $payable_id; ?>
															</td>
															...
															<td class="cell" style="padding-top: 1em"><?php echo $date = date("M d, Y - h:i a", strtotime($date_received)); ?></td>
															<?php
															...
															?>
															<td><a href="payable-details.php?ID=<?php echo $id; ?>" class="btn app-btn btn-success" style="color:white"><i class="fa fa-eye"></i> View</a></td>
														</tr>
												<?php
													}
												} else {
