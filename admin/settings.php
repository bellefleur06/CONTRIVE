    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <h1 class="app-page-title"><span class="nav-icon"></span>User Settings</h1>
                <hr class="mb-4">
                <!-- alert messages -->
                <?php
                ...
                <div class="row g-4 settings-section">
                    ...
                    <h3 class="section-title">Manage Database</h3>
                    <div class="mb-3">
                        <a href="backup-database.php" class="btn app-btn btn-primary" style="color:white"><i class="fa fa-download"></i> Backup Database</a>
                    </div>
                </div>
            </div>
            <!--//row-->
