                                    ...
                                    <table id="myTable" class="table app-table-hover mb-0 text-left">
                                        <thead>
                                            <div class="clearfix">
                                                ...
                                                <a href="project-requirements.php?ID=<?php echo $project_id; ?> " target="blank" class="btn app-btn btn-success" style="color:white; float:right"><i class="fas fa-plus" style="color:white"></i></a>
                                            </div>
                                            <hr>
                                            <tr>
                                    ...
                                    <table id="myTable1" class="table app-table-hover mb-0 text-left">
                                        <thead>
                                            <div class="clearfix">
                                                ...
                                                <a href="project-workers.php?ID=<?php echo $project_id; ?> " target="blank" class="btn app-btn btn-success" style="color:white; float:right"><i class="fas fa-plus" style="color:white"></i></a>
                                            </div>
                                            <hr>
                                            <tr>
