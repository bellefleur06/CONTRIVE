...
if (isset($_POST['submit'])) {
	...
	$activity = "Update " . $access . " Details For " . $full_name;
	...
	$sql = "UPDATE staffs SET full_name = '$full_name', birthday = '$bday', age = '$age', gender = '$gender', address = '$address', contact = '$contact', civil_status = '$civil_status', profile = '$image_name', status = '$status', access = '$access' WHERE id = '$id'";
	$result = mysqli_query($conn, $sql);
	...
	if ($result == TRUE) {
		...
		$_SESSION['update-staffs'] = "Staff Details Updated Successfully!";
	} else {
...
<head>
	<title>CONTRIVE | Update Staffs</title>
	...
	<div class="app-wrapper">
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				<h1 class="app-page-title text-success"><span class="nav-icon"><i class="fa fa-user"></i></span> Update Staff</h1>
				<hr class="mb-4">
				<!-- alert messages -->
				<?php
				if (isset($_SESSION['update-staffs'])) {
				?>
					<div class="alert alert-success alert-dismissible fade show" id="alert" role="alert">
						<strong> <?php echo $_SESSION['update-staffs']; ?> </strong>
						<button type="button" class="btn-close" data-dismiss="alert" aria-label="Close"></button>
					</div>
				<?php
					unset($_SESSION['update-staffs']);
				}
						...
						<div class="app-card app-card-settings shadow-sm p-4">
							<div class="app-card-body">
								<form class="settings-form" method="post" enctype="multipart/form-data">
									...
									<div class="mb-3">
										<fieldset class="form-group">
											<label for="setting-input-3" class="form-label">User Role: </label>
											<select name="access" class="form-select" id="basicSelect" required>
												...
												<option value="Clerk" <?php echo ($row['access'] == "Clerk") ? 'selected' : ''; ?>>Staff/Clerk</option>
												<option value="Accountant" <?php echo ($row['access'] == "Accountant") ? 'selected' : ''; ?>>Accountant</option>
												<option value="Engineer" <?php echo ($row['access'] == "Engineer") ? 'selected' : ''; ?>>Engineer</option>
											</select>
										</fieldset>
									</div>
									...
									<a href="staff-details.php?ID=<?php echo $row['id']; ?>" class="btn app-btn btn-info" style="color:white; float:right"><i class="fa fa-arrow-left"></i> Go Back</a>
								</form>
							</div>
							<!--//app-card-body-->
