...
if (!isset($_POST['ID'])) {
    ...
    $activity = "Delete Worker - " . $first_name . " " . $last_name  . " - " . $position;
    ...
    if (isset($_POST['delete'])) {
        ...
        if ($result == TRUE) {
            ...
            $_SESSION['delete-workers'] = "Worker Removed Successfully!";
            header("Location: manage-workers.php");
        } else {

            $_SESSION['failed-to-delete'] = "Failed to Remove Worker.";
            header("Location: manage-workers.php");
        }
    }
}
