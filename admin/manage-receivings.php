...
<head>
    <title> CONTRIVE | Manage Receivings</title>
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <ol class="breadcrumb mb-4" style="float:right">
                    ...
                    <li class="breadcrumb-item active">Manage Receivings</li>
                </ol>
                <h1 class="app-page-title"><span class="nav-icon"><i class="fa fa-list"></i></span> Manage Receivings</h1>
                ...
                if (isset($_SESSION['failed-to-receive'])) {
                ?>
                    <div class="alert alert-danger alert-dismissible fade show" id="alert" role="alert">
                        <strong> <?php echo $_SESSION['failed-to-receive']; ?> </strong>
                        <button type="button" class="btn-close" data-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php
                    unset($_SESSION['failed-to-receive']);
                }
                ?>
                                ...
                                <form class="settings-form">
                                    <div class="mb-3">
                                        <table id="myTable" class="table app-table-hover mb-0 text-left">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql = "SELECT * FROM materials, orders WHERE orders.product_id = materials.id AND status = 'On Delivery' ORDER BY orders.id DESC";
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><a href="receiving-order-details.php?ID=<?php echo $id; ?>" class="btn app-btn btn-success" style="color:white"><i class="fa fa-eye"></i> View</a></td>
                                                        </tr>
                                                <?php
                                                    }
                                                } else {
